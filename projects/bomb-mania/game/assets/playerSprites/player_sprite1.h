...
static const u8 g_Player1SpritePatterns[] =
{
    ...
    // Superior izquierdo
    0x03, 0x07, 0x0F, 0x1F, 0x1B, 0x1F, 0x0E, 0x06,

    // Inferior izquierdo
    0x0F, 0x1F, 0x3B, 0x33, 0x03, 0x07, 0x0C, 0x18,

    // Superior derecho
    0x00, 0x80, 0xC0, 0xE0, 0x60, 0xE0, 0xE0, 0xC0,
    ...
    // Superior izquierdo
    0x01, 0x03, 0x07, 0x0F, 0x0D, 0x0F, 0x07, 0x03,

    // Inferior izquierdo
    0x0F, 0x1F, 0x3B, 0x33, 0x03, 0x07, 0x0E, 0x10,

    // Superior derecho
    0x80, 0xC0, 0xE0, 0xF0, 0xB0, 0xF0, 0xE0, 0xC0,

    // Inferior derecho
    0xC0, 0xE0, 0x70, 0x30, 0x00, 0xC0, 0x60, 0x20,
    ...
    // Inferior izquierdo
    0x0F, 0x1F, 0x3B, 0x33, 0x03, 0x06, 0x0C, 0x08,

    // Superior derecho
    0x00, 0x80, 0xC0, 0xE0, 0x60, 0xE0, 0xC0, 0x80,

    // Inferior derecho
    0xC0, 0xE0, 0x70, 0x30, 0x00, 0x80, 0x70, 0x10,
    ...
    // Superior izquierdo
    0x03, 0x07, 0x0F, 0x1F, 0x1F, 0x1F, 0x0E, 0x06,

    // Inferior izquierdo
    0x0F, 0x1F, 0x3F, 0x33, 0x03, 0x07, 0x0C, 0x10,

    // Superior derecho
    0x00, 0x80, 0xC0, 0xE0, 0xE0, 0xE0, 0xE0, 0xC0,

    // Inferior derecho
    0xC0, 0xE0, 0xF0, 0x30, 0x00, 0xC0, 0x60, 0x20,
    ...
    // Superior izquierdo
    0x01, 0x03, 0x07, 0x0F, 0x0F, 0x0F, 0x07, 0x03,

    // Inferior izquierdo
    0x0F, 0x1F, 0x3F, 0x33, 0x03, 0x06, 0x0E, 0x08,

    // Superior derecho
    0x80, 0xC0, 0xE0, 0xF0, 0xF0, 0xF0, 0xE0, 0xC0,

    // Inferior derecho
    0xC0, 0xE0, 0xF0, 0x30, 0x00, 0x80, 0x70, 0x10,
    ...
    // Inferior izquierdo
    0x07, 0x1F, 0x3F, 0x37, 0x27, 0x07, 0x0C, 0x06,
    ...
    // Inferior izquierdo
    0x07, 0x1F, 0x3F, 0x37, 0x27, 0x07, 0x06, 0x0C,
    ...
    // Inferior derecho
    0xE0, 0xF8, 0xFC, 0xEC, 0xE4, 0xE0, 0x30, 0x60,
    ...
    // Inferior derecho
    0xE0, 0xF8, 0xFC, 0xEC, 0xE4, 0xE0, 0x60, 0x30
};
